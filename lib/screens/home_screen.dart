                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: selectedCategories == category ? Colors.blue : Colors.grey.shade100,
                        borderRadius: BorderRadius.circular(20),),
                      child: Center(
                        child: Text(category.toUpperCase(),
                        style: TextStyle(color: selectedCategories == category ? Colors.white : Colors.black)),
                      ),
                    ),
                  );
                },
